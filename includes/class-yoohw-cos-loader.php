...
final class YoOhw_COS_Loader {
	...
	private static function includes(): void {
		...
		require_once YOOHW_COS_PATH . 'includes/class-yoohw-cos-extensions.php';
		require_once YOOHW_COS_PATH . 'includes/class-yoohw-cos-customer-facts.php';
		require_once YOOHW_COS_PATH . 'includes/class-yoohw-cos-attention.php';
		...
		require_once YOOHW_COS_PATH . 'includes/class-yoohw-cos-privacy-erasure.php';
		...
		require_once YOOHW_COS_PATH . 'includes/class-yoohw-cos-diagnostics.php';
		require_once YOOHW_COS_PATH . 'includes/class-yoohw-cos-email-notifications.php';
