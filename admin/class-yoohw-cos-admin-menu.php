...
final class YoOhw_COS_Admin_Menu {
	...
	private static function render_diagnostics( array $diagnostics ): void {
		...
		$rows = array(
			...
			'Freshness worker' => $diagnostics['intelligence']['worker']['status'] . ' — ' . $diagnostics['intelligence']['worker']['scanned'] . ' scanned, ' . $diagnostics['intelligence']['worker']['updated'] . ' updated, page ' . $diagnostics['intelligence']['worker']['next_page'],
